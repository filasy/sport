...
//        params.max = Math.min(max ?: 8, 100)
        ...
        if (round){
            ...
            games = Game.findAllByRoundInList(Round.findAllByLocked(true))
        }
        return [games: games, countGames: games.size(), users: users, selectedUser: params.userID, selectedRound:  params.roundID]
    }
